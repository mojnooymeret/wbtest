...
namespace OzonWb
{
   ...
   {
      private static string token { get; set; } = "6123367281:AAFrPTXtsRggDpUdP4j-7rzR40YL0FfUGEU"; // токен бота // 6287927206:AAE4uZ2ej2uFpRsCsIA5CPvd3Zjwn6v-SZM
      ...
      private static long chanelId = -1001753358180; // id канала где работает бот // 1001871495356
         ...
         try {
            ...
            for (int i = 0; i < data.Count; i++) {
               ...
               try {                                                                               // добавляется рандомный user-agent
                  ...
                  photo = string.Empty;
                  driver.Url = data[i].url; // открываем ссылку в браузере                 
                  await Task.Delay(9000); // задержка 7 секунд для антибана + прогрузки страницы
                  ...
                  if (result == string.Empty) {
                     ...
                     if (result == string.Empty)
                        try {
                           result = driver.FindElement(By.CssSelector("#layoutPage > div.b0 > div.container.b4 > div.m8o.mp3 > div.m8o.mp4.mp1.m1p > div.m8o.mp4.mp1.pm1 > div > div > div > div.p0n > div > div > div > div > span.w5m.mw6 > span")).Text.Replace(" ", " ");
                        } catch { }
                  }
                  try {
                  ...
                  if (photo == string.Empty) {
                     try {
                        photo = driver.FindElement(By.CssSelector("#layoutPage > div.b0 > div.container.b4 > div.m8o.mp3 > div.m8o.mp4.p2m > div.e0 > div.d5.c7 > div > div:nth-child(2) > div > div.o0m > div.wk8 > div > img")).GetAttribute("src");
                     } catch { }
                     if (photo == string.Empty) {
                        try {
                        ...
                        if (photo == string.Empty) {
                           photo = driver.FindElement(By.CssSelector("#layoutPage > div.b0 > div.container.b4 > div.m8o.mp3 > div.m8o.mp4.p2m > div.e0 > div.d5.c7 > div > div:nth-child(2) > div > div.n9m > div.mo.om0 > div > div.o6m > div:nth-child(3) > div > img")).GetAttribute("src");
                           photo = photo.Replace("wc50", "wc1000");
                        }
                     }
                  }
